...
public class Db2HandlerIT extends CommonTestCases {
    ...
    static final RestService app = new RestService()
            .withProperty("quarkus.datasource.db2.username", "test")
            //            .withProperty("quarkus.datasource.db2.username", db2.getUser())
            .withProperty("quarkus.datasource.db2.password", "test")
            //            .withProperty("quarkus.datasource.db2.password", db2.getPassword())
            .withProperty("quarkus.datasource.db2.jdbc.url", "jdbc:db2://localhost:50000/amadeus")
            //            .withProperty("quarkus.datasource.db2.jdbc.url", db2::getJdbcUrl)
            .withProperty("quarkus.datasource.db2.reactive.url", "db2://localhost:50000/amadeus")
